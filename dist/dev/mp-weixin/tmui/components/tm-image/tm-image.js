  ...
  setup(__props, { emit: emits }) {
    ...
    return (_ctx, _cache) => {
      return common_vendor.e({
        ...
        J: common_vendor.sr(aniplay, "02f921e0-0", {
          "k": "aniplay"
        }),
        ...
        M: `${props.margin[0] + props.unit} ${(props.margin.length > 1 ? props.margin[1] : props.margin[0]) + props.unit}`
      }) : {});
    };
  }
});
const Component = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["__file", "D:/Folders/裕农通/uniapp/src/tmui/components/tm-image/tm-image.vue"]]);
