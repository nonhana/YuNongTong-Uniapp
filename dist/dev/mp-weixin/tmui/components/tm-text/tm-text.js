...
const _sfc_main = /* @__PURE__ */ common_vendor.defineComponent({
  ...
  setup(__props, { emit: emits }) {
    ...
    const _fontSize = common_vendor.computed(() => {
      var _a, _b;
      return Number(props.fontSize) * (((_b = (_a = store == null ? void 0 : store.tmuiConfig) == null ? void 0 : _a.themeConfig) == null ? void 0 : _b.globalFontSizeRatio) ?? 1);
    });
...
const Component = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["__scopeId", "data-v-3acfd808"], ["__file", "D:/Folders/裕农通/uniapp/src/tmui/components/tm-text/tm-text.vue"]]);
